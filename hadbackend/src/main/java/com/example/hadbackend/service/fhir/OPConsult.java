...
//            genereateoprecord();
//        }
        public static Bundle genereateoprecord() throws DataFormatException, IOException
        {
        ...
        static void init() throws DataFormatException, FileNotFoundException
        {
            ...
            //json
//            String[] fileList = new File("/home/aswathanarayanan/HAD/private/hadbackend/hadbackend/src/main/java/com/example/hadbackend/fhirprofilesjson/k/").list(new WildcardFileFilter("*.json"));
//            for(String file:fileList)
//            {
//                //Parse All Profiles and add to prepopulated support
//                sd = parser.parseResource(StructureDefinition.class, new FileReader("/home/aswathanarayanan/HAD/private/hadbackend/hadbackend/src/main/java/com/example/hadbackend/fhirprofilesjson/k/"+file));
//                prePopulatedSupport.addStructureDefinition(sd);
//            }
            String[] fileList = new File("/home/aswathanarayanan/HAD/definitions.xml/").list(new WildcardFileFilter("*.xml"));
            ...
            {
                //Parse All Profiles and add to prepopulated support
                sd = parser.parseResource(StructureDefinition.class, new FileReader("/home/aswathanarayanan/HAD/definitions.xml/"+file));
                prePopulatedSupport.addStructureDefinition(sd);
            }
